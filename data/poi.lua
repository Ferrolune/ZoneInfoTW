...
ZoneInfoTW.PointOfInterests = {
    ...
    --Kalimdor
        ...
        ["Alterac Mountains"] = {
            ...
            ["Chillwind Post"]={flag="0000",low=32,high=34},
        },
        ["Wetlands"] = {
        ...
        ["Ashenvale"] = {
            ...
            ["Thistlefur Village"]={flag="1001",low=20,high=24},
            ["Iris Lake"]={flag="1001",low=21,high=23},
            ["The Talondeep Path"]={flag="1010",low=21,high=23},
            ["Mystral Lake"]={flag="1001",low=23,high=25},
            ["Silverwind Refuge"]={flag="0000",low=21,high=25},
            ["Greenpaw Village"]={flag="1001",low=23,high=25},
            ["Bloodtooth Camp"]={flag="1001",low=23,high=30},
            ["Crescent Grove"]={flag="1001",low=30,high=33},
            ["Raynewood Retreat"]={flag="0000",low=24,high=29},
            ["The Howling Vale"]={flag="1001",low=22,high=32},
            ["Night Run"]={flag="1001",low=24,high=27},
            ["Silverwing Outpost"]={flag="0000",low=20,high=23},
            ["Silverwing Grove"]={flag="0000",low=19,high=21},
            ["Warsong Labor Camp"]={flag="0100",low=19,high=30},
            ["The Dor'Danil Barrow Den"]={flag="1001",low=20,high=32},
            ["Satyrnaar"]={flag="1001",low=26,high=28},
            ["Xavian"]={flag="1001",low=28,high=30},
            ["Forest Song"]={flag="0000",low=28,high=30},
        ...
        ["Teldrassil"]={
            ...
            ["Ban'ethil Hollow"]={flag="1001",low=6,high=7},
            ["Ban'ethil Barrow Den"]={flag="1001",low=7,high=9},
            ["Pools of Arlithrien"]={flag="1001",low=7,high=8},
            ["Gnarlpine Hold"]={flag="1001",low=7,high=12},
            ["Lake Al'Ameth"]={flag="1001",low=5,high=8},
            ["Starbreeze Village"]={flag="1001",low=5,high=7},
            ["Dolanaar"]={flag="0000",low=5,high=6},
            ["Shadowglen"]={flag="1010",low=1,high=2},
            ["Aldrassil"]={flag="0000",low=1,high=2},
        ...
        ["Icepoint Rock"]={
            ["The Kaneq'nuun"]={flag="1010",low=41,high=43},
        },
        ["Arathi Highlands"]={
        ...
        ["Tel'Abim"]={
            ["Tel Co. Basecamp"]={flag="1010",low=53,high=54},
            ["Tazzo's Shack"]={flag="1000",low=53,high=55},
            ["The Derelict Camp"]={flag="1001",low=53,high=57},
            ["Highvale Rise"]={flag="1001",low=53,high=59},
            ["Bixxle's Storehouse"]={flag="1000",low=56,high=57},
            ["The Jagged Isles"]={flag="1001",low=55,high=59},
        },
        ["Western Plaguelands"]={
            ["The Bulwark"]={flag="0100",low=50,high=52},
            ["Felstone Field"]={flag="1001",low=50,high=54},
            ["Dalson's Tears"]={flag="1001",low=52,high=55},
            ["Northridge Lumber Camp"]={flag="1001",low=52,high=59},
            ["Hearthglen"]={flag="1001",low=55,high=63},
            ["Thondroril River"]={flag="1001",low=54,high=56},
            ["The Writhing Haunt"]={flag="1001",low=52,high=56},
            ["Gahrron's Withering"]={flag="1001",low=56,high=58},
            ["The Weeping Cave"]={flag="1001",low=54,high=57},
            ["Darrowmere Lake"]={flag="1001",low=51,high=57},
            ["Scholomance"]={flag="1001",low=51,high=57},
            ["Ruins of Andorhal"]={flag="1001",low=54,high=61},
            ["Chillwind Camp"]={flag="0000",low=50,high=51},
            ["Sorrow Hill"]={flag="1001",low=50,high=52},
            ["Uther's Tomb"]={flag="0000",low=50,high=52},
        },
        ["Tirisfal Glades"] = {
            ["The Bulwark"] = {flag="0100", low=7, high=9},
            ["Balnir Farmstead"] = {flag="1001", low=7, high=12},
            ["Crusader Outpost"] = {flag="1001", low=8, high=11},
            ["Venomweb Vale"] = {flag="1001", low=8, high=10},
            ["Whispering Gardens"] = {flag="1001", low=29, high=60},
            ["Scarlet Watch Post"] = {flag="1001", low=7, high=12},
            ["Brightwater Lake"] = {flag="1001", low=5, high=9},
            ["Garren's Haunt"] = {flag="1001", low=6, high=10},
            ["Brill"] = {flag="0100", low=5, high=7},
            ["Undercity"] = {flag="0100", low=15, high=15},
            ["Nightmare Vale"] = {flag="1001", low=5, high=9},
            ["Cold Hearth Manor"] = {flag="1001", low=5, high=7},
            ["Stillwater Pond"] = {flag="1001", low=5, high=7},
            ["Agamand Mills"] = {flag="1001", low=6, high=13},
            ["Deathknell"] = {flag="1010", low=1, high=5},
            ["Night Web's Hollow"] = {flag="1001", low=2, high=5},
            ["Solliden Farmstead"] = {flag="1001", low=5, high=7},
            ["The Lafford House"] = {flag="1001", low=15, high=17},
            ["The Garrick Stead"] = {flag="0000", low=14, high=17},
            ["The Whispering Forest"] = {flag="1001", low=13, high=18},
            ["Glenshire"] = {flag="0100", low=14, high=17},
            ["Gracestone Mine"] = {flag="1001", low=14, high=18},
            ["Crumblepoint Tower"] = {flag="1001", low=14, high=15},
            ["Ishnu'Danil"] = {flag="0000", low=30, high=30},
            ["The Corinth Farmstead"] = {flag="1001", low=14, high=20},
            ["Shatteridge Tower"] = {flag="0000", low=15, high=20},
            ["The Remnants Camp"] = {flag="0000", low=14, high=21},
            ["The Blacktower Inn"] = {flag="1001", low=15, high=16},
            ["The Jagged Hills"] = {flag="1001", low=15, high=20},
            ["Steepcliff Port"] = {flag="0100", low=16, high=19},
        },
        ["Darkshore"]={
            ["Ruins of Mathystra"]={flag="1001",low=18,high=21},
            ["Tower of Althalaxx"]={flag="1001",low=16,high=31},
            ["Cliffspring River"]={flag="1001",low=13,high=18},
            ["Cliffspring Falls"]={flag="1001",low=15,high=18},
            ["Bashal'Aran"]={flag="1001",low=10,high=17},
            ["Auberdine (Town)"]={flag="0000",low=9,high=10},
            ["Ameth'Aran"]={flag="1001",low=10,high=16},
            ["Wildbend River"]={flag="1001",low=13,high=17},
            ["Grove of the Ancients"]={flag="0000",low=17,high=19},
            ["Blackwood Den"]={flag="1001",low=16,high=20},
            ["The Master's Glaive"]={flag="1001",low=16,high=18},
            ["Remtravel's Excavation"]={flag="1001",low=11,high=20},
        },
        ["Aszhara"]={
            ["Talrendis Point"]={flag="1000",low=45,high=47},
            ["Shadowsong Shrine"]={flag="1001",low=45,high=47},
            ["Haldarr Encampment"]={flag="1001",low=45,high=48},
            ["Valormok"]={flag="0100",low=45,high=53},
            ["Timbermaw Hold"]={flag="1001",low=47,high=51},
            ["Ursolan"]={flag="1001",low=49,high=53},
            ["Legash Encampment"]={flag="1001",low=50,high=54},
            ["Bloodfist Point"]={flag="0100",low=50,high=53},
            ["Thalassian Base Camp"]={flag="1001",low=50,high=53},
            ["Bitter Reaches"]={flag="1001",low=52,high=54},
            ["Jagged Reef"]={flag="1001",low=50,high=54},
            ["Tower of Eldara"]={flag="1001",low=51,high=54},
            ["The Shattered Strand"]={flag="1001",low=50,high=54},
            ["Temple of Arkkoran"]={flag="1001",low=51,high=55},
            ["ruins of Eldarath"]={flag="1001",low=48,high=52},
            ["Temple of Zin-Malor"]={flag="1001",low=48,high=55},
            ["Southridge Beach"]={flag="1001",low=50,high=55},
            ["Bay of Storms"]={flag="1001",low=53,high=55},
            ["Hetaera's Clutch"]={flag="1001",low=53,high=55},
            ["Scalebeard's Cave"]={flag="1001",low=53,high=54},
            ["Rethress Sanctum"]={flag="1010",low=53,high=55},
            ["The Ruined Reaches"]={flag="1001",low=50,high=55},
            ["Flaxwhisker Front"]={flag="0000",low=53,high=54},
            ["Forlorn Ridge"]={flag="1001",low=49,high=53},
            ["Lake Mennar"]={flag="1001",low=48,high=54},
            ["Ravencrest Monument"]={flag="1001",low=53,high=57},
        },
